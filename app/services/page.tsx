        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <Reveal>
            <div className="flex h-full flex-col rounded-3xl border border-forest-100 bg-sand/50 p-8 shadow-card">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-cream text-forest-700">
                <EnrichmentIcon className="h-6 w-6" />
              </span>
              <h3 className="mt-5 text-xl font-semibold">{enrichment.title}</h3>
          ...
          <Reveal delay={0.1}>
            <div className="flex h-full flex-col rounded-3xl bg-forest-800 p-8 text-cream shadow-card">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-forest-700 text-cream">
                <GraduationCap className="h-6 w-6" />
              </span>
              <h3 className="mt-5 text-xl font-semibold text-cream">APEX Full-Time Program</h3>
